...
-- The three questions the study actually asks: how much use over time, how
-- much per site, and how much per device (return rate).
CREATE INDEX IF NOT EXISTS idx_events_received ON events (received_at);
CREATE INDEX IF NOT EXISTS idx_events_cohort   ON events (cohort, received_at);
